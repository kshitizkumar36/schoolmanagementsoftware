...
foreach ($photo as $key)
 ...
 <div class="col-6 shadow p-4">
    ...
    <div class="mdb-lightbox no-margin">
      ...
      <label class="form-control bg-warning"><b><?php echo $key['title']; ?></b></label>
      ...
      <figure class="">
        <a href="admin/gallery/<?php echo $key['photo']; ?>" >
          <img style="height: 400px; width: 600px;"   src="admin/gallery/<?php echo $key['photo']; ?>"
            class="img-fluid">
        </a>
      </figure>
