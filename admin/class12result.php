...
if(isset($_POST['submit']))
{
    ...
    $remark= $_POST['remark'];
	$query="INSERT INTO `class12result`( `year`, `registered_students`, `students_passed`, `pass_percentage`, `remarks`) VALUES ('$year','$registered_students','$passed_students','$pass_percentage','$remark')";
					      ...
					      <td><?php print_r($data['remarks']); ?></td>
					        <td>
					      	<form method="post" action="mdcaremove.php">
					      		...
					      		<input type="submit" value="X" class="text-danger" name="12remove">
					      	</form>
